            ...
            <div className="max-w-container mx-auto px-6 flex flex-col gap-6 items-center">
                ...
                <div className="w-full flex items-center justify-between text-paragraph-xxs text-content-secondary font-medium">
                    <div className="flex items-center gap-5">
                        <a
                            target="_blank"
                            href="https://legal.slingshot.fm/send-terms-2507b"
                        ...
                        <a
                            target="_blank"
                            href="https://legal.slingshot.fm/send-privacy-2507a"
                            className="hover:text-content-primary transition-colors"
                            rel="noreferrer noopener"
                        >
                            Privacy
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <a
                            target="_blank"
                            href="https://github.com/slingshot/bolter"
                            className="hover:text-content-primary transition-colors"
                            rel="noreferrer noopener"
                        >
                            Source
