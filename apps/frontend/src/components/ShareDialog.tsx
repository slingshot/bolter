...
export function ShareDialog({ file, onClose }: ShareDialogProps) {
    ...
    return (
        // biome-ignore lint/a11y/noStaticElementInteractions: Dialog backdrop dismissal
        // biome-ignore lint/a11y/useKeyWithClickEvents: Escape key handled by convention
        <div
        ...
        >
            ...
            {/* biome-ignore lint/a11y/useKeyWithClickEvents: No keyboard action needed */}
            <div
                className={cn(
                    'card-glass w-full max-w-[600px] p-card shadow-card animate-slide-up',
                )}
